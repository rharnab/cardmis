...
function chargeBalance($acc_no, $pId_amt, $debit_sl, $payable_amount, $rate)
{
	...
	// Multiple Transaction
	   ...
	   $bnk_response = mysql_real_escape_string($bnk_response);
		...
		//store log for caharge apply
			$insert_cvs_log  = mysql_query("INSERT INTO auto_card_cvs_charge_log (log_id, error, cvs_log, log_type, logTimeStamp ) values ('$debit_sl', '$bnk_error', '$bnk_response', '1', '$currentTimeStamp') ");
