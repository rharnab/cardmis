                        ...
                        .then((value)=>{
                            ...
                            if(value)
                            {
                                 ...
                                 $.ajax({
                                    ...
                                    type:'post',
                                    data:{data:acc,noc:noc,otherPhone:otherPhone,otherEmail:otherEmail, card_request: card_request, card_number: card_number, issue_branch:issue_branch, narration:narration},
