...
function chargeBalance($acc_no, $pId_amt, $debit_sl)
{
	...
	// Multiple Transaction
			...
			array(
				"transactionList" => array(
					...
					array(
						...
						"DrCr"       => "CR",
						"ChequeNo"   => " ",
						"Remarks"    => "debit charge deducation by vsl",
						"BranchCode" => "0067"			
					)
				),
				"commonInfo" => array(			
	   ...
	   $bnk_response = mysql_real_escape_string($bnk_response);
		...
		return $api_data = array('batch_no' => $batch_no, 'msg'=> $message, 'TraceNoList_0'=> $TraceNoList_0, 'TraceNoList_1' => $TraceNoList_1, 'bnk_error'=> $bnk_error);
