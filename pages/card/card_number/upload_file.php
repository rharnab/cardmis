            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">CIB</a></li>
                        <li class="active">Import Card Number file</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                               <div class="box-header">
                                ...
                                <div class="box-body">
                                  <!-- from -->
                                   <div class="tile-body">
                                      <form id="defaultForm" class="form-horizontal" name="info" action="save_card_number_txt.php" method="post" enctype="multipart/form-data">
        ...
        var formData = new FormData(form);
          ...
          if(filePath !='')
          {
            ...
            if(allowedExtensions.exec(filePath))
            {
                ...
                swal({
                  title: "DO YOU WANT INSERT THESE CARD NUMBER ?? ",
                  icon: "success",
                  buttons: true,
                  dangerMode: true,
                })
