        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Debit card Pin Re-issue</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Re-issue</a></li>
                        <li class="active">Debit card Pin Re-issue</li>
                    </ol>
                </section>
                                        ...
                                        <div class="col-md-12" style="margin-top: 15px;">
                                         ...
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <strong class="pull-right" style="color:red; margin-top:5px;">*</strong>
                                                <input type="text" id="card_number" name="card_number" placeholder="Enter card number" class="form-control">
        ...
        <script>
            ...
            $( function(){
                ...
                $(document).on('submit','#debitCardForm',function(event){
                    ...
                    var phone = /^-?\d*(\.\d+)?$/;
                    var card_request = $('#card_request').val();
                    ...
                    if(acc== '' && noc =='' && card_request == '' && card_number == ''){
                    ...
                    }else if(card_request =='')
                    {
                         $("#card_requestErrorMsg").text("Please select Card Request").css('color','red').fadeIn(100).fadeOut(1000);
                    }else if(narration =='')
                    {
                        ...
                        .then((value)=>{
                            ...
                            if(value)
                            {
                                 ...
                                 $.ajax({
                                    ...
                                    type:'post',
                                    data:{data:acc,noc:noc,otherPhone:otherPhone,otherEmail:otherEmail, rcv_branch: rcv_branch, card_request: card_request, card_number: card_number, issue_branch:issue_branch, narration:narration},
