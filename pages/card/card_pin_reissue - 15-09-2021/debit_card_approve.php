<?php 
    ...
    if($_SESSION['branch_id'] =='1')
    {
        ...
        if(trim($status) =='dishonour')
        {
         ...
         $update_aprrove = mysql_query("UPDATE debit_card_api SET card_status='$status',approve_by_id='$approve_id',approve_date='$approveDate',batch_num='$fb_num', status='$aut_status', remarks='$remarks' WHERE accountno= '$acc_num' and request_type='5' ");
        ...
        $update_aprrove = mysql_query("UPDATE debit_card_api SET status='$status', approve_by_id= '$approve_id', remarks='$remarks' WHERE accountno='$acc_num' and request_type='5' ");
