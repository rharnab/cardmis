        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Create XML file for  debit Card Re-issue</h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Card Re-issue</a></li>
                        <li class="active">Card Re-issue/li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <tbody>
                                        <?php
                                            $debit_card_api = mysql_query("SELECT dcp.*, en.user_fname, en.user_lname, br.br_title as request_branch, rcvbr.br_title as receiving_branch, apr.user_fname as apr_fname, apr.user_lname as apr_lname, issue.br_title as issue_branch
                                                ...
                                                WHERE dcp.card_status !='dishonour' AND dcp.card_status !='' and dcp.status = '2' and dcp.request_type='2' group by dcp.accountno ");
