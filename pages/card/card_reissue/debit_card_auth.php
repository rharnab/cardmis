        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Authentication Debit Card Re-issue</h1>
                    <div id="success"></div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Authentication Debit Card Re-issue</li>
                    </ol>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            $debit_card_api = mysql_query("SELECT dcp.*, en.user_fname, en.user_lname, br.br_title as request_branch, rcvbr.br_title as receiving_branch,  issue.br_title as issue_branch
                                                ...
                                                left join branches rcvbr on rcvbr.id = dcp.receive_branch where dcp.accountno <> '' and request_type='2' $branch_sql group by dcp.accountno");
