<?php
	...
	if(empty($api_data)){
		...
		$debit_insert = mysql_query(" INSERT INTO debit_card_api (accountno, customerid, accounttype, actypecode, accountname, accstatus, accnameoncard, accopendate, accfather, nationalid, accphone, accotheremail, accotherphone, accaddress, accdateofbirth,accsex, bal_tk, entry_by_id, requestDate, branch_id, status, receive_branch, request_type, issue_branch, narration, accmother) VALUES ('$acc_no', '$customerid', '$accounttype', '$actypecode', '$accountname', '$accstatus', '$accnameoncard', '$accopendate', '$accfather', '$nationalid', '$accphone', '$accotheremail', '$accotherphone', '$accaddress', '$accdateofbirth', '$accsex', '$bal_tk','$entry_by_id', '$currentDate', '$branch_id', '0', '$rcv_branch', '$request_type', '$issue_branch', '$narration', '$mothers_name') ");
