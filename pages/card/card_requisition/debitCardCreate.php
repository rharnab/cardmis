...
<html>
    ...
    <body class="skin-blue">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="father_name">Father Name</label>
                                                          <strong class="pull-right" style="color:red; margin-top:5px;">*</strong>
                                                        <input type="text" id="father_name" name="father_name" placeholder="Enter Father Name" class="form-control">
                                                        <span id="father_nameErrorMsg"></span>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="mother_name">Mother Name</label>
                                                          <strong class="pull-right" style="color:red; margin-top:5px;">*</strong>
                                                        <input type="text" id="mother_name" name="mother_name" placeholder="Enter Mother Name" class="form-control">
                                                        <span id="mother_nameErrorMsg"></span>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <span id="ganderErrorMsg"></span>
                                                    </div>
                                                </div>

                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="birth_dt">Date Of Birth</label>
                                                          <strong class="pull-right" style="color:red; margin-top:5px;">*</strong>
                                                        <input type="text" id="birth_dt" name="birth_dt"  class="form-control" placeholder="YY-MM-DD">
                                                        <span id="birth_dtErrorMsg"></span>
                                                    </div>
                                                </div>
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="marketed_by">RM Code</label>
                                                        <input type="text" id="marketed_by" name="marketed_by" placeholder="Enter Marketed By" class="form-control">
                                                        <span id="marketed_byErrorMsg"></span>
                                                    </div>
                                                </div>
                                            </div> <!-- col-md-6 -->
                                    ...
                                    <table class="table table-hover table-bordered">
                                         <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td>Gender:  <strong id="gender_show"></strong></td>
        ...
        <script>
            ...
            document.getElementById("nocard").addEventListener("keyup", forceUppercase, false);
            document.getElementById("father_name").addEventListener("keyup", forceUppercase, false);
            document.getElementById("mother_name").addEventListener("keyup", forceUppercase, false);
            ...
            $( function(){
                    ...
                    if(value !=''){
                        $.ajax({
                            ...
                            success:function(res){
                                ...
                                document.getElementById("gender_show").innerHTML = jsonData.sex;
                                ...
                                // set input filed 
                                $('#father_name').val(jsonData.father_hus);
                                $('#mother_name').val(jsonData.mother_name);
                                $('#gender').val(jsonData.sex);
                                $('#birth_dt').val(date_formate);
                ...
                $(document).on('submit','#debitCardForm',function(event){
                    ...
                    if(acc== '' && noc ==''){
                        ...
                        $("#rcv_branchErrorMsg").text("Please Select receiving branch ").css('color','red').fadeIn(100).fadeOut(1000);
                    }

                    else if(father_name ==''){
                        $("#father_nameErrorMsg").text("Please give father name").css('color','red').fadeIn(100).fadeOut(1000);
                    }else if(mother_name ==''){
                        $("#mother_nameErrorMsg").text("Please give mother name").css('color','red').fadeIn(100).fadeOut(1000);
                    }else if(gender ==''){
                        $("#ganderErrorMsg").text("Please give gander").css('color','red').fadeIn(100).fadeOut(1000);
                    }else if(birth_dt ==''){
                        $("#birth_dtErrorMsg").text("Please give Birth Date").css('color','red').fadeIn(100).fadeOut(1000);
                    }
                        ...
                        .then((value)=>{
                            ...
                            if(value)
                            {
                                 $.ajax({
                                    ...
                                    type:'post',
                                    data:{data:acc,noc:noc,otherPhone:otherPhone,otherEmail:otherEmail, rcv_branch: rcv_branch, issue_branch: issue_branch, narration:narration, father_name:father_name, mother_name:mother_name, gender:gender, birth_dt:birth_dt, marketed_by:marketed_by},
