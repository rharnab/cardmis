                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            $debit_card_api = mysql_query("SELECT dcp.*, en.user_fname, en.user_lname, br.br_title as request_branch, rcvbr.br_title as receiving_branch
                                                ...
                                                left join branches rcvbr on rcvbr.id = dcp.receive_branch where dcp.accountno <> '' and request_type='1' $branch_sql ");
                                        ...
                                        ?>  
                                            <tr>
                                                ...
                                                <!-- <td>
                                                  ...
                                                  <td> <input type="text" id="remarks" name="remarks"  placeholder="Remarks" class="form-conrol"> </td>
