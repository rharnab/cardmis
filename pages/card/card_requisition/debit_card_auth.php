        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Authentication New Debit Card</h1>
                    <div id="success"></div>
  ...
  .page_loader{
    ...
    width: 37%
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            $debit_card_api = mysql_query("SELECT dcp.*, en.user_fname, en.user_lname, br.br_title as request_branch, rcvbr.br_title as receiving_branch, issue.br_title as issue_branch
                                                ...
                                                left join branches rcvbr on rcvbr.id = dcp.receive_branch where dcp.accountno <> '' and request_type='1' $branch_sql group by dcp.accountno ");
                                        ...
                                        ?>  
                                            <tr>
                                                      ...
                                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <input type="text" class="form-control" name="remarks" id="remarks_<?php echo $rowData['accountno'] ?>" placeholder="Remark">
                                                          </div>
                                                          <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-primary" onclick="Authorize('5', '<?php echo $rowData['accountno'] ?>')" type="button">Dishonor</button>
                                                ...
                                                <td>
                                                     ...
                                                     <button class="btn btn-danger" id="<?php echo $rowData['accountno'] ?>" onclick="dishonourBtn(id)" type="button">Dishonor</button>
        ...
        <script type="text/javascript">
            ...
            {
                var remarks = $('#remarks_'+accno).val();
