...
<?php 
 ...
 $br_select = mysql_query("SELECT DISTINCT br_division FROM branches where br_division <> '' ");
    $br_data = '';
            ...
            $(document).ready(function(){
                $('#submitBtn').click(function(event){
                    ...
                    if($("#brName").val() == ''){
                        ...
                        $("#brDiviNoti").fadeIn('fast').text("This field are required").css('color','red').fadeOut(2000);
                    }else if($("#brDis").val() == ''){
                        $("#brDisNoti").fadeIn('fast').text("This field are required").css('color','red').fadeOut(2000);
