                            ...
                            <table class="table  userlistTable" style="font-size: 12px; text-align: center;">
                                        ...
                                        <tbody>
                                        		...
                                        		$debit_card_api = mysql_query("SELECT accounttype, count(accounttype) as t_request from debit_card_api dcp
                                                    where dcp.requestDate between '$frm_dt' and '$to_dt' and  dcp.accountno <> '' $branch_sql $account_type_sql and dcp.status in (2,3,5) group by dcp.accounttype  ");
                                          ...
                                          where requestDate between '$frm_dt' and '$to_dt' and accounttype='$acc_type'  and card_status='approve'
                                          ...
                                          where requestDate between '$frm_dt' and '$to_dt' and accounttype='$acc_type' and card_status='dishonour'
                                          $count_branch_sql group by card_status");
