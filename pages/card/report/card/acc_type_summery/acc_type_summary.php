 ...
 if($_SESSION['branch_id'] == 1)
 {
  ...
  <script>
    ...
    function generateReport()
    {
      ...
      popupwindow = window.open("acc_type_summary_info.php?frm="+document.info.frm.value+'&to='+document.info.to.value+'&branch='+document.info.branch.value+'&account_type='+document.info.account_type.value, 'newWindow', 'top=200, width=800, height=500, left=500, scrollbars=1, toolbar=no, resizable=false');
