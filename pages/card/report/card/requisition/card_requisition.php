 ...
 if($_SESSION['branch_id'] == 1)
 {
                                ...
                                <div class="box-body">
                                  <!-- from -->
                                   ...
                                   <label class="control-label" >Start Date</label>
                                      ...
                                      <div class="form-group row" style="margin-top: 10px;">
                                        <div class="col-md-10">
                                          <select name="rqst_type" class="form-control" id="rqst_type">
                                      ...
                                      <div class="form-group row" style="margin-top: 10px;">
                                        <div class="col-md-10">
                                          ...
                                          <option value="">ALL</option>
                                           <option value="dishonour">Dishonor</option>
  ...
  <script>
    ...
    function generateReport()
    {
      ...
      popupwindow = window.open("requisiton_info.php?frm="+document.info.frm.value+'&to='+document.info.to.value+'&sts='+document.info.sts.value+'&branch='+document.info.branch.value+'&rqst_type='+document.info.rqst_type.value, 'newWindow', 'top=200, width=800, height=500, left=500, scrollbars=1, toolbar=no, resizable=false');
